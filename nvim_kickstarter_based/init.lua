...
vim.keymap.set('n', '<C-s>', ':w<CR>', { desc = 'Switch to normal mode' })
vim.keymap.set('i', 'jj', '<Esc>', { desc = 'Switch to normal mode' })

vim.keymap.set('n', '<C-t>', ':split<CR> :term<CR> A', { desc = 'Open new terminal session' })
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      for server_name, server_config in pairs(ext_servers) do
