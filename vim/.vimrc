...
" Start FZF when Vim starts with a directory argument.
autocmd StdinReadPre * let s:std_in=1
autocmd VimEnter * if argc() == 1 && isdirectory(argv()[0]) && argv()[0] == "." && !exists('s:std_in') |
    \ call timer_start(80, { tid -> execute('Files')}) | endif
